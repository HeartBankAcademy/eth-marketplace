// Adapted from:
// https://github.com/aragon/aragonOS/blob/c76fac8dba440185abee5c89816987ae10139895/test/helpers/assertThrow.js
...
module.exports = {
  ...
  async assertThrow(codeBlock, message = 'should have failed by throwing') {
    return assertThrows(codeBlock, message, '')
  }
}
